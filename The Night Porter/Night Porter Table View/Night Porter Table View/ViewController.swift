...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func toggleDarkMode(_ sender: Any) {
        ...
        // sender represents a view object
    ...
    var dailyTasks = [
        ...
        Task(name: "Check all doors", type: .daily
            , completed: true, lastCompleted: nil),
    ...
    // Add swipe actions like delete when the user swipe the row
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        ...
        // Clears the tableview background color
        tableView.backgroundColor = UIColor.clear
        return 3 // return 3. One for daily, weekly, and monthly tasks
    }
    ...
    // This method return the cell for each row
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        
        // dequeue a row. Reusuing cell is a best practice and more efficent
...
//
//        // Adds the accessory icon on the right
...
//        cell.detailTextLabel?.text = "This is some detail text"
        ...
        // Clear the background color of each cell
        cell.backgroundColor = UIColor.clear
        
        return cell
    }
    
    // Title the header in a section
